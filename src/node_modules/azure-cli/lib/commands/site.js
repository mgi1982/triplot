...
exports.init = function(cli) {
  ...
  site.command("create [name]").whiteListPowershell().description("Create a new web site").option("-s, --subscription <id>", "use the subscription id").option("--location <location>", "the geographic region to create the website").option("--hostname <hostname>", "custom host name to use").option("--git", "configure git on web site and local folder").option("-pu, --publishingUsername <publishingUsername>", "The publishing username for git").option("--github", "configure github on web site and local folder").option("--githubusername <username>", "The github username").option("--githubpassword <password>", "The github password").option("--githubrepository <repository>", "The github repository full name (i.e. user/repository)").execute(function __3(nameArg, options, _) { var context;
    ...
    function ensureSpaces(context, _) { var __frame = { name: "ensureSpaces", line: 373 }; return __func(_, this, arguments, ensureSpaces, 1, __frame, function __$ensureSpaces() { return (function __$ensureSpaces(__then) {
          if (!context.spaces) {
  ...
  function portalCreateSiteInstruction(context, _) { var href; var __frame = { name: "portalCreateSiteInstruction", line: 383 }; return __func(_, this, arguments, portalCreateSiteInstruction, 1, __frame, function __$portalCreateSiteInstruction() {
  ...
  function getPublishingUser(context, _) { var publishingUsers, filters; var __frame = { name: "getPublishingUser", line: 402 }; return __func(_, this, arguments, getPublishingUser, 1, __frame, function __$getPublishingUser() {
  ...
  function portalGitInitInstruction(context, _) { var href; var __frame = { name: "portalGitInitInstruction", line: 420 }; return __func(_, this, arguments, portalGitInitInstruction, 1, __frame, function __$portalGitInitInstruction() {
  ...
  location.command("list").whiteListPowershell().description("List locations available for your account").execute(function __4(options, _) { var context, spaces, s; var __frame = { name: "__4", line: 443 }; return __func(_, this, arguments, __4, 1, __frame, function __$__4() {
  ...
  site.command("browse [name]").whiteListPowershell().description("Open your web site in a browser.").option("-s, --subscription <id>", "use the subscription id").execute(function __5(name, options, _) { var context, cache, siteData, href; var __frame = { name: "__5", line: 466 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 9, 22, function ___(__0, __2) { cache = __2; return (function __$__5(_) {
          var __1 = cache; if (__1) { return _(null, __1); } ; return site.doSiteGet(context, __cb(_, __frame, 10, 40, _, true)); })(__cb(_, __frame, -465, 17, function ___(__0, __3) { siteData = clean(__3);
  ...
  site.command("show [name]").whiteListPowershell().description("Show details for a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __6(name, options, _) { var context, result, repositoryUri, gitUri, settings, data, index; var __frame = { name: "__6", line: 487 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__6() {
        ...
        return async.parallel([function __1(_) { var __frame = { name: "__1", line: 501 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
            return site.doSiteGet(context, __cb(_, __frame, 0, 34, _, true)); });
        },function __2(_) { var __frame = { name: "__2", line: 502 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return site.doSiteConfigGet(context, __cb(_, __frame, 0, 34, _, true)); }); },], __cb(_, __frame, 13, 23, function ___(__0, __3) { result = __3;
  ...
  function lookupSiteName(context, _) { var cfg; var __frame = { name: "lookupSiteName", line: 534 }; return __func(_, this, arguments, lookupSiteName, 1, __frame, function __$lookupSiteName() {
  ...
  function lookupSiteWebSpace(context, _) { var sites, index; var __frame = { name: "lookupSiteWebSpace", line: 555 }; return __func(_, this, arguments, lookupSiteWebSpace, 1, __frame, function __$lookupSiteWebSpace() {
  ...
  function lookupSiteNameAndWebSpace(context, _) { var cache; var __frame = { name: "lookupSiteNameAndWebSpace", line: 569 }; return __func(_, this, arguments, lookupSiteNameAndWebSpace, 1, __frame, function __$lookupSiteNameAndWebSpace() {
  ...
  function ensureRepositoryUri(context, _) { var siteData, repositoryUri; var __frame = { name: "ensureRepositoryUri", line: 643 }; return __func(_, this, arguments, ensureRepositoryUri, 1, __frame, function __$ensureRepositoryUri() {
  ...
  site.command("delete [name]").whiteListPowershell().description("Delete a web site").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for delete confirmation").execute(function __7(name, options, _) { var context, progress, result; var __frame = { name: "__7", line: 662 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__7() {
        ...
        log.info("Deleting site", context.site.name); return (function __$__7(_) {
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return confirm((("Delete " + context.site.name) + " site?  (y/n) "), __cb(_, __frame, 11, 33, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -661, 17, function ___(__0, __2) { return (function __$__7(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__7() {
  ...
  site.command("start [name]").whiteListPowershell().description("Start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __8(name, options, _) { var context; var __frame = { name: "__8", line: 700 }; return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
  ...
  site.command("stop [name]").whiteListPowershell().description("Stop a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __9(name, options, _) { var context; var __frame = { name: "__9", line: 721 }; return __func(_, this, arguments, __9, 2, __frame, function __$__9() {
  ...
  site.command("restart [name]").whiteListPowershell().description("Stop and then start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __10(name, options, _) { var context; var __frame = { name: "__10", line: 742 }; return __func(_, this, arguments, __10, 2, __frame, function __$__10() {
  ...
  function updateSiteState(channel, context, newState, _) { var progress, result; var __frame = { name: "updateSiteState", line: 760 }; return __func(_, this, arguments, updateSiteState, 3, __frame, function __$updateSiteState() {
  ...
  site.readConfig = function site_readConfig__11(_) { var __frame = { name: "site_readConfig__11", line: 799 }; return __func(_, this, arguments, site_readConfig__11, 0, __frame, function __$site_readConfig__11() {
  ...
  site.writeConfig = function site_writeConfig__12(cfg, _) { var __frame = { name: "site_writeConfig__12", line: 806 }; return __func(_, this, arguments, site_writeConfig__12, 1, __frame, function __$site_writeConfig__12() {
  ...
  site.readConfigValue = function site_readConfigValue__13(name, _) { var result; var __frame = { name: "site_readConfigValue__13", line: 811 }; return __func(_, this, arguments, site_readConfigValue__13, 1, __frame, function __$site_readConfigValue__13() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_readConfigValue__13() {
  ...
  site.writeConfigValue = function site_writeConfigValue__14(name, value, _) { var __frame = { name: "site_writeConfigValue__14", line: 822 }; return __func(_, this, arguments, site_writeConfigValue__14, 2, __frame, function __$site_writeConfigValue__14() {
  ...
  site.doSpacesGet = function site_doSpacesGet__15(options, _) { var progress, result, spaces; var __frame = { name: "site_doSpacesGet__15", line: 920 }; return __func(_, this, arguments, site_doSpacesGet__15, 1, __frame, function __$site_doSpacesGet__15() {
      log.verbose("Subscription", options.subscription);
  ...
  site.doSitesGet = function site_doSitesGet__16(options, _) { var spaces, channel, progress, result, sites; var __frame = { name: "site_doSitesGet__16", line: 942 }; return __func(_, this, arguments, site_doSitesGet__16, 1, __frame, function __$site_doSitesGet__16() {
      log.verbose("Subscription", options.subscription);
      ...
      return site.doSpacesGet(options, __cb(_, __frame, 3, 17, function ___(__0, __2) { spaces = __2;
        ...
        progress = cli.progress("Enumerating sites"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doSitesGet__16() {
              ...
              return async.map(spaces, function __1(webspace, _) { var __frame = { name: "__1", line: 956 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  site.doSiteConfigPUT = function site_doSiteConfigPUT__17(config, options, _) { var progress, xmlConfig; var __frame = { name: "site_doSiteConfigPUT__17", line: 1033 }; return __func(_, this, arguments, site_doSiteConfigPUT__17, 2, __frame, function __$site_doSiteConfigPUT__17() {
  ...
  site.doRepositoryGet = function site_doRepositoryGet__18(options, _) { var siteData; var __frame = { name: "site_doRepositoryGet__18", line: 1055 }; return __func(_, this, arguments, site_doRepositoryGet__18, 1, __frame, function __$site_doRepositoryGet__18() {
  ...
  site.doPublishingUsersGet = function site_doPublishingUsersGet__19(options, _) { var progress, publishingUsers; var __frame = { name: "site_doPublishingUsersGet__19", line: 1060 }; return __func(_, this, arguments, site_doPublishingUsersGet__19, 1, __frame, function __$site_doPublishingUsersGet__19() {
